...
namespace UI_Info
{
	...
	D3DXCOLOR ExpCol = { 0.0f,1.0f,0.0f,1.0f };
...
//更新
//=============================================
void UI_PlayerExp::Update()
{
	SetGauge(m_Exp);		//ゲージ値セット
	CObject2D::UpdateGauge();//ゲージ更新
	//親クラスの更新
	CObject2D::Update();
}
...
//生成
//=============================================
UI_PlayerExp* UI_PlayerExp::Create(D3DXVECTOR3 pos, int MaxExp)
{
	using namespace UI_Info;
	CTexture* pTexture = CManager::GetInstance()->GetTexture();
	UI_PlayerExp* pUI = new UI_PlayerExp;
